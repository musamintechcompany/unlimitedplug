        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('digital-assets.update', $digitalAsset) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="title" value="{{ old('title', $digitalAsset->name) }}" required 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="subcategory" value="{{ old('subcategory', $digitalAsset->subcategory) }}" required 
                        ...
                        <div>
                            ...
                            <input type="text" name="tags" value="{{ old('tags', $digitalAsset->tags ? implode(', ', $digitalAsset->tags) : '') }}" 
                        ...
                        <div>
                            ...
                            <textarea name="features" rows="4" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('features', $digitalAsset->features ? implode("\n", $digitalAsset->features) : '') }}</textarea>
