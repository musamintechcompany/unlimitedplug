    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-12">
            ...
            <div class="flex items-center">
                <!-- Mobile Hamburger -->
                <button @click="open = !open; $dispatch('sidebar-toggle', { open: open }); document.body.style.overflow = open ? '' : 'hidden'" class="p-2 rounded-lg text-gray-700 hover:bg-gray-100 md:hidden mr-2">
