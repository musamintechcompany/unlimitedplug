        ...
        <div class="flex justify-between items-center h-12">
            ...
            <div class="flex items-center space-x-2 sm:space-x-4">
                ...
                <button onclick="toggleAdminNotifications()" class="relative text-gray-500 hover:text-gray-700 p-2">
                    ...
                    <span id="admin-notification-count" class="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center hidden">0</span>
                </button>
